...
1. **橡皮图章"通过率上升"挂错了门**（binary 恒定 0.250，上升的是 PPL 门 0.167→0.235）。正文按"论文摘要这么概括，但表里两个门不一样"直述，不写成作者自我纠正。
2. **"数学证明 AI 自审必然崩"夸大了**，定理前提已假设橡皮图章。正文直述定理前提，不加"我说准一点"这类自证严谨的话。
