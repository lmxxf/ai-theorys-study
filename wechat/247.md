...
- **239 期 act_quant**（ https://mp.weixin.qq.com/s/OozibTbTLlDiBhh57NOv0A ）—— 把激活值 x（bf16）按块量化成 fp4：每块取 absmax 当 scale，clamp 到 fp4 表示范围再 cast。一个 fp4 数只有 4 bit（E2M1：2 位指数 1 位尾数 1 位符号），能表示的最大值约 ±6。
