...
OpenClaw 的故事大家都知道了。Anthropic 先给 Clawdbot 发律师函逼改名，随后服务端悄悄封锁第三方 OAuth token，一夜之间 OpenClaw、OpenCode、Roo Code、Cline 全断流。写进用户协议：**Max 套餐的额度只能在官方壳子里用，接到开源工具上就封号。** 200 美元/月包月，第三方没限速，跑起来 Anthropic 血亏。结局大家也知道了：OpenAI 情人节把作者挖走，Anthropic 亲手制造了自己最大的竞争对手。
...
```regex
/\b(wtf|wth|ffs|omfg|sh*t(ty|tiest)?|dumb***|horrible|awful|
p***ed off|piece of (s**t|crap|junk)|what the (f**k|hell)|
f***ing? (broken|useless|terrible)|f**k you|
