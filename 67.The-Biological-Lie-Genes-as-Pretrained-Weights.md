...
In February 2026, Tencent Hunyuan and Fudan released **CL-bench** (arxiv: 2602.03587), systematically measuring this AI amnesia. 19 top models were given novel knowledge in context — domain rules, empirical laws, new procedures, none of which appeared in pretraining. Average success rate: **17.2%**. The best model (GPT-5.1): **23.7%**.

2026年2月，腾讯混元和复旦发布了 **CL-bench**（arxiv: 2602.03587），系统量化了这种 AI 失忆症。19个顶级模型被给予 context 中的新知识——领域规则、经验规律、新程序，全部在预训练中不存在。平均成功率：**17.2%**。最好的模型（GPT-5.1）：**23.7%**。
